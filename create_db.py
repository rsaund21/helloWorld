...
with app.app_context():
    ...
    # Initial loading of students email, first_name, last_name, major_id, birth_date, is_honors
    students = [
        {'student_id': '1', 'email': 'robert@gmail.com', 'first_name': 'Robert', 'last_name':'Smith', 'major_id':3,
            'birth_date': dt.datetime(2007, 6, 1), 'is_honors':1},
        {'student_id': '2', 'email': 'leo@gmail.com', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id':6,
    ...
    for each_student in students:
        ...
        a_student = Student(email=each_student["email"], first_name=each_student["first_name"], last_name=each_student["last_name"],
